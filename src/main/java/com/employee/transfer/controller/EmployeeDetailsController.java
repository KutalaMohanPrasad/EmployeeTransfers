...
public class EmployeeDetailsController {
	...
	public ResponseEntity<EmployeeTransferResponse> updateEmployeeDetails(@RequestBody UpdateUserRequest request) throws Exception{
		Status status =null;
		System.out.println("reqwuest:"+request.toString());
		if(request ==null) {
	...
	public ResponseEntity<EmployeeTransferResponse> createEmployee(@RequestBody EmployeeDetailsDTO request) throws Exception {
		Status status =null;
		if(request == null) {
			status = Status.FAILURE;
		} else {
